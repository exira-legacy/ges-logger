...
let project = "Exira.EventStore.Logger"

// Short summary of the project
// (used as description in AssemblyInfo and as a short summary for NuGet package)
let summary = "Exira.EventStore.Logger is a Topshelf service to log EventStore events using Serilog"

// Longer description of the project
// (used as a description for NuGet package; line breaks are automatically cleaned up)
let description = "Exira.EventStore.Logger is a Topshelf service to log EventStore events using Serilog"

// List of author names (for NuGet package)
let authors = [ "exira" ]

// Tags for your project (for NuGet package)
let tags = "eventstore ges topshelf logging f#"

// File system information
let solutionFile  = "ges-logger.sln"
