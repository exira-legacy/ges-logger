...
<div class="row">
  ...
  <div class="span6">
    <div class="well well-small" id="nuget">
      The ges-runner library can be <a href="https://nuget.org/packages/Exira.EventStore.Runner">installed from NuGet</a>:
      <pre>PM> Install-Package Exira.EventStore.Runner</pre>
    </div>
  </div>
  <div class="span1"></div>
</div>
