...
let referenceBinaries = [ "ges-logger\\ges-logger.exe" ]
// Web site location for the generated documentation
let website = "/ges-logger"

let githubLink = "http://github.com/exira/ges-logger"

// Specify more information about your project
let info =
  [ "project-name", "ges-logger"
    "project-author", "exira"
    "project-summary", "Exira.EventStore.Logger is a Topshelf service to log EventStore events using Serilog"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/Exira.EventStore.Logger" ]
